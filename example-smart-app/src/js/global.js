...
/*
	...
	*/
	...
	$.ajax({
		...
		url: "https://fhir-open.sandboxcerner.com/dstu2/0b8a0111-e8e6-4c26-a91c-5069cbc6b1ca/DocumentReference?patient="+patID+"&created=ge2019-04-01&created=le"+ todayDate+"&_count=20",
		cache: false,
		type: "GET",
		beforeSend: function(xhr) {
