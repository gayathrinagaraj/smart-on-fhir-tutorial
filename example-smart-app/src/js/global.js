...
function displayQuestionnaire(QR, formOID){
	...
	$.ajax({
		...
		success: function(data) { 
			...
			screen += "<div style=\'height: 50px; font-style: italic; font-size: 24px; margin-bottom: 5em; margin-left:3em;\'>" + data.contained[0].item[0].item[0].text+ "</div>";
			...
			var temp2 = JSON.parse(tmp);
					...
					screen += "<div style=\'height: 50px; width: 100px; margin-top: 0.5em;\'><input type=\'button\' class=\'btn-submit\' id=\'" + item.modifierExtension[0].valueString + "\' name=\'" + item.text + "\' value=\'" + item.text + "\' onclick= \'nextQuestion( \"" +linkId+ "\",\"" +valueString+ "\",\"" +system+ "\",\"" +code+ "\", \"" +display+ "\",\"" +text+ "\",\"" +tempOID+ "\");  \' />" + "</div>";
			...
			screen += "<div style=\'height: 50px; font-style: italic; font-size: 24px; margin-bottom: 5em; margin-left:3em;\'>" + data.contained[0].item[0].item[0].text + " "+ data.contained[0].item[0].item[1].text+"</div>";
